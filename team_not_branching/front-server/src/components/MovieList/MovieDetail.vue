...
<!-- <iframe width="560" height="315" :src="`https://www.youtube.com/watch?v=${movie.video_key}`" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>-->

<iframe id="player" width="640" height="360"
  :src="`https://www.youtube.com/watch?v=${movie.video_key}`"
